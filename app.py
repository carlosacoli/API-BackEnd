...
class Factura_ingreso(db.Model):
    ...
    base_imp = db.Column(db.Numeric(precision=20, scale=2), nullable=False)
    iva = db.Column(db.Numeric(precision=20, scale=2), nullable=False)
    total_ingreso = db.Column(db.Numeric(precision=20, scale=2), nullable=False)
...
class Factura_gasto(db.Model):
    ...
    base_imp = db.Column(db.Numeric(precision=20, scale=2), nullable=False)
    iva = db.Column(db.Numeric(precision=20, scale=2), nullable=False)
    total_gasto = db.Column(db.Numeric(precision=20, scale=2), nullable=False)
    archivo = db.Column(db.LargeBinary, nullable=False)
    nombre_archivo = db.Column(db.VARCHAR(100), nullable=False)
    estado_factura = db.Column(db.String, nullable=False)
    id_factura_usuario = db.Column(db.Integer, db.ForeignKey('usuarios.id_usuario'), nullable= False)
