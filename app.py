...
class Factura_ingreso(db.Model):
    ...
    base_imp = db.Column(db.Float(precision=20, scale=2), nullable=False)
    iva = db.Column(db.Float(precision=20, scale=2), nullable=False)
    total_ingreso = db.Column(db.Float(precision=20, scale=2), nullable=False)
